    ...
    <div class="row">
        ...
        <div class="col-6 center">
            <div class="referencia text-center">
                ...
                <div class="row">
                    <span id="descripcion" class="desc text-center"></span>
                </div>
            </div>
        </div>
    ...
    function getPedidosAndInventario(){
        ...
        dataType: 'json',
            success: function(data){
                document.getElementById('descripcion').innerHTML = data[4];
                $("#alerts").html(data[3])
                var obj = [
                ...
                for(var i=0; i<data[0].length; i++){
                    ...
                    <td>`+data[0][i].nombre+" - "+data[0][i].nit+" - "+data[0][i].suc+" - "+data[0][i].ciudad+`</td>
                    <td>CORRERIA: `+data[0][i].correria+` - OBS PED: `+data[0][i].observaciones+" - OBS CAR: "+data[0][i].obscartera+`</td>
