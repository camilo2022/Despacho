...
<div class="container-fluid mt-2">
    <div class="card" style=" font-family:Century Gothic;">
        ...
        IMPRIMIR ORDENES DE DESPACHO
        </div>
            <div class="card-body">
                <div class="table-responsive text-center">
                    <input style="width:25%;" type="button" class="btn btn-dark" onclick="printDiv('areaImprimir')" value="Imprimir" />
                    <a type="button" class="btn btn-success" style="width: 25%" href="/filtro/listado/ordenes/facturar/excel">Exportar Excel</a>
                </div>
            </div>
    </div>
</div>
...
<div class="" id="areaImprimir">
    @foreach($ordenes as $orden)
    <div id="apper">
        <div class="container-fluid mt-2 tamano">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 datos_cliente justify-content-center align-self-center">
                            <div class="row">
                                ...
                                <div class="col-md-9 datos_cliente"> <b>{{$orden[0]->nit}}</b> </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 datos_cliente"> <label>CLIENTE:</label> </div>
                                <div class="col-md-9 datos_cliente"> <b>{{$orden[0]->cliente}}</b> </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 datos_cliente"> <label>DEPARTAMENTO:</label> </div>
                                <div class="col-md-9 datos_cliente"> <b>{{$orden[0]->departamento}}</b> </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 datos_cliente"> <label>CIUDAD:</label> </div>
                                <div class="col-md-9 datos_cliente"> <b>{{$orden[0]->ciudad}}</b> </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 datos_cliente"> <label>DIRECCION:</label> </div>
                                <div class="col-md-9 datos_cliente"> <b>{{$orden[0]->direccion}}</b> </div> 
                            </div>
                            <div class="row">
                                <div class="col-md-3 datos_cliente"> <label>SUCURSAL:</label> </div>
                                <div class="col-md-9 datos_cliente"> <b>{{$orden[0]->sucursal}}</b> </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 datos_cliente"> <label>FECHA:</label> </div>
                                <div class="col-md-9 datos_cliente"> <b>{{$orden[0]->fecha}}</b> </div>
                            </div> 
                            <div class="row">
                                <div class="col-md-3 datos_cliente"> <label>OBSERVACIONES:</label> </div>
                                <div class="col-md-9 datos_cliente"> <b>{{$orden[0]->obs." - ".$orden[0]->obscartera}}</b> </div>
                            </div>                     
                        </div>
                        ...
                        <div class="col-md-4 text-center justify-content-center align-self-center">
                            ...
                            <div class="consecutivo">{{$orden[0]->consecutivo}}</div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
