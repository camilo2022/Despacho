...
<div class="container-fluid mt-2">
    <div class="card" style=" font-family:Century Gothic;">
      <div class="card-header text-center" style="background-color: #333; color:white; font-weigth:bold;">
        REPORTE ORDENES DE DESPACHO POR REFERENCIA
        </div>
            <div class="card-body">
                <div class="">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-center">
                                <div class="form-group c_form_group">
                                    ...
                                    <select data-placeholder="Seleccione" class="chosen-select form-control" id="referencia">
                                        <option value=""></option>
...
<script>
    ...
    $(document).ready(function(){
        $("#generar").click(function() {
            ...
            var url = URLdominio + "referencia/generar";
            var referencia = $("#referencia").val();
            
            if(referencia == null || referencia == "" || referencia == undefined){
                alertify.error('Referencia requerido');
            }else{
                    $("#tablar").html( `<div class="container-fluid mt-2">
                                    <div class="card" style=" font-family:Century Gothic;">
                                    <div class="card-header text-center" style="background-color: #333; color:white; font-weigth:bold;">
                                        CONSULTA ORDENES DESPACHO POR REFERENCIA
                                    </div>
                                        <div class="card-body">
                                    ...
                                    $(document).ready(function(){
                                        $('#ordenesDespacho').DataTable({
                                            ...
                                            buttons: [{
                                                    ...
                                                    filename: 'DESPACHAR LA REFERENCIA : '+referencia,
