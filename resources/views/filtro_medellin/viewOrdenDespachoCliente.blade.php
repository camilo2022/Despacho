    ...
    INFORMACION DEL CLIENTE
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <span class="data">{{$cliente->zona}}</span>
                </div>
                <div class="col-2">
                                    ...
                                    <tr>
                                        <td>
                                            @if($d->estado_detalle_orden == "APROBADO")
                                                <a style="cursor:pointer;" href="{{route('filtro.medellin.listado.ordenes.clientes.estado.cancelado',[$d->id_dod, $d->id_amarrador])}}" title="CANCELA referencia en pedido y orden"><span class="badge badge-danger">&#x2716</span>
                                                <a style="cursor:pointer;" href="{{route('filtro.medellin.listado.ordenes.clientes.estado.pendiente',[$d->id_dod, $d->id_amarrador])}}" title="PENDIENTE por filtrar nuevamente"><span class="badge badge-warning"><i class="fa fa-solid fa-retweet"></i></span>
                                            @elseif($d->estado_detalle_orden == "ALISTAR")
                                                <a style="cursor:pointer;" href="{{route('filtro.medellin.listado.ordenes.clientes.edit.detalle',[$consecutivo, $d->id_amarrador])}}" title="EDITAR curva a despachar"><span class="badge badge-info"><i class="fa fa-solid fa-marker"></i></span>
                                            @elseif(($cliente->estado_orden == "ALISTANDO" || $cliente->estado_orden == "PREPARANDO") && ($d->estado_detalle_orden == "CANCELADO" || $d->estado_detalle_orden == "PENDIENTE"))
                                                <a style="cursor:pointer;" href="{{route('filtro.medellin.listado.ordenes.clientes.estado.aprobado',[$d->id_dod, $d->id_amarrador])}}"><span class="badge badge-success">&#x2714</span>
                                            @endif
                                        </td>
                                        <td>
                                            @if($d->estado_detalle_orden == "APROBADO")
                                        ...
                                        <td>
                                            @if($d->despachor == 4)
                                                NEGADO
                                            @elseif($d->despachor == 1)
                                                DESPACHADO
                                            @elseif($d->despachor == 0)
                                                EN CURSO
                                            @elseif($d->despachor == 12)
                                                COMPROMETIDO
                                            @endif
                                        </td>                                                                 
                                    </tr>
