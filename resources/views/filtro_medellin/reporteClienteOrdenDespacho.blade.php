...
<div class="container-fluid mt-2">
    <div class="card" style=" font-family:Century Gothic;">
      <div class="card-header text-center" style="background-color: #333; color:white; font-weigth:bold;">
        REPORTE ORDENES DE DESPACHO POR CLIENTE
        </div>
            <div class="card-body">
                <div class="">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-center">
                                <div class="form-group c_form_group">
                                    <label>Cliente</label>
                                    <select data-placeholder="Seleccione" class="chosen-select form-control" id="documento">
                                        <option value=""></option>
                                        @foreach($clientes as $cliente)
                                            <option value="{{$cliente->nit.' - '.$cliente->direccion}}">{{$cliente->cliente.' - '.$cliente->direccion}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
...
<script>
    ...
    $(document).ready(function(){
        $("#generar").click(function() {
            ...
            var url = URLdominio + "cliente/generar";
            var documento = $("#documento").val();
            var documento = documento.split(' - ');
                                    ...
                                    $(document).ready(function(){
                                        $('#ordenesDespacho').DataTable({
                                            ...
                                            buttons: [{
                                                    ...
                                                    filename: 'DESPACHAR AL CLIENTE: '+documento,
