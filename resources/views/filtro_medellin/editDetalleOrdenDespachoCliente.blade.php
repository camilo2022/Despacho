    ...
    DETALLES ORDEN DESPACHO
        ...
        <div class="card-body">
            <div class="table-responsive">
                <div class="row">
                    <div class="col-12">
                    <form method="post"action="{{route('filtro.medellin.listado.ordenes.clientes.update.detalle',[$consecutivo, $amarrador, $detalleOrdenCliente->id_dod])}}" accept-charset="UTF-8">
                    @csrf
