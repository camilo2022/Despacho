        ...
        IMPRIMIR ORDENES DE DESPACHO
            ...
            <div class="card-body">
                <div class="table-responsive text-center">
                    ...
                    <a type="button" class="btn btn-success" style="width: 25%" href="/filtro/medellin/listado/ordenes/facturar/excel">Exportar Excel</a>
                </div>
            </div>
    </div>
</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 datos_cliente justify-content-center align-self-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 datos_cliente"> <b>{{$orden[0]->zona}}</b> </div>
                            </div>
                            <div class="row">
