                                ...
                                <div class="form-group c_form_group">
                                    ...
                                    <select name="correria" id="correria" class=" required form-control" tabindex="0" required="">
                                        ...
                                        @foreach ($correrias as $c)
                                            <option style="font-weight: bold" value="{{$c->nombre.' - '.$c->fechaini.' - '.$c->fechafin}}">{{$c->nombre." / ".$c->fechaini." - ".$c->fechafin}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
...
<script>
    ...
    $(document).ready(function(){
        $("#generar").click(function() {
            ...
            var url = URLdominio + "produccion/generar";
                                    ...
                                    $(document).ready(function(){
                                        $('#ordenesDespacho').DataTable({
                                            ...
                                            buttons: [{
                                                    ...
                                                    filename: 'INFORME DE PRODUCCION',
